!(function (n, r) {
  ...
  function an(n, r, t, e) {
    ...
    if (!o) {
      ...
      if (
        f !== c &&
        !(D(f) && f instanceof f && D(c) && c instanceof c) &&
        'constructor' in n &&
        'constructor' in r
      )
        return !1;
    ...
    e = e || [];
    for (var l = (t = t || []).length; l--; ) if (t[l] === n) return e[l] === r;
    if ((t.push(n), e.push(r), o)) {
      if ((l = n.length) !== r.length) return !1;
      for (; l--; ) if (!on(n[l], r[l], t, e)) return !1;
    } else {
      var s,
        p = nn(n);
      if (((l = p.length), nn(r).length !== l)) return !1;
      for (; l--; ) if (!W(r, (s = p[l])) || !on(n[s], r[s], t, e)) return !1;
    }
  ...
  var ln = 'forEach',
    ...
    vn = sn.concat(ln, pn),
    hn = sn.concat(pn),
    yn = ['add'].concat(sn, ln, 'has'),
    dn = F ? cn(vn) : x('Map'),
    gn = F ? cn(hn) : x('WeakMap'),
    bn = F ? cn(yn) : x('Set'),
    mn = x('WeakSet');
  function jn(n) {
